  ...
  useEffect(() => {
    const loadDashboard = async () => {
      try {
        ...
        if (typeof window !== "undefined") {
          try {
            ...
            if (storedUser) {
              ...
              if (name) {
                setManufacturerName(String(name));
              }
            }
          } catch {
        ...
        const backendBatches: BackendBatch[] =
        ...
        if (medicinesResponse.ok) {
          ...
          const backendMedicines: BackendMedicine[] =
          ...
          setMedicineCount(backendMedicines.length);
        }

        /* ================= LATEST BATCH VERIFICATION ================= */

        if (mappedBatches.length > 0) {
          const latestBatch = [...mappedBatches].sort(
            (a, b) =>
          ...
          try {
            ...
            if (verifyResponse.ok) {
              ...
              const score = Number(
                verifyData?.trust_score ??
                  verifyData?.data?.trust_score
              );
            ...
            // Keep default trust score if verification is unavailable
          }
        }
      } catch (err) {
            ...
            <div className="group mt-6 rounded-2xl border border-[#E4E7EC] bg-white p-5 transition-all duration-300 hover:-translate-y-1 hover:border-[#00A878] hover:bg-[#ECFDF5] hover:shadow-md">
                  ...
                  {latestBatch ? (
                    <>
                      ...
                      <p className="mt-1 text-sm text-[#475467]">
                        {latestBatch.medicine} ·{" "}
                        {latestBatch.quantity} units
                      </p>
                    </>
                  ) : (
                    <p className="mt-1 text-sm text-[#667085]">
              ...
              {latestBatch && (
                <Link
                  ...
                  className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-[#00A878] hover:underline"
                >
                  View batch details
                  <ArrowRight size={15} />
                </Link>
          ...
          <div className="mt-14">
            ...
            <div className="group mx-auto mt-10 max-w-4xl rounded-3xl border border-[#A7F3D0] bg-[#F8FAFC] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#00A878] hover:bg-[#ECFDF5] hover:shadow-md md:p-8">
              ...
              <div className="mt-7 grid gap-3 md:grid-cols-5">
                <ScoreItem title="Manufacturer" score="+20" />
                <ScoreItem title="Distributor" score="+20" />
                <ScoreItem title="Pharmacy" score="+20" />
                <ScoreItem title="Blockchain" score="+20" />
                <ScoreItem title="Cold Chain" score="+10" />
              </div>
              ...
              <div className="mt-7">
                ...
                <div className="h-3 overflow-hidden rounded-full bg-[#E4E7EC]">
                  <div
                    className="h-full rounded-full bg-[#00A878] transition-all duration-500"
                    style={{
                      width: `${trustScore}%`,
                    }}
                  />
