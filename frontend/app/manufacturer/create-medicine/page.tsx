  ...
  <div className="rounded-2xl border border-[#A7F3D0] bg-[#F0FDF8] p-6 md:p-8">
    ...
    <div className="flex flex-col items-center text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-[#A7F3D0]">
        <CheckCircle2 size={34} className="text-[#00A878]" />
      </div>
    ...
    <div className="mt-7 flex flex-col items-center">
      <p className="mb-3 text-xm text-[#667085]">
          ...
          >
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                <label className="mb-2 block text-sm font-semibold text-[#101828]">
                  Medicine Name <span className="text-[#F97316]">*</span>
                </label>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-xl border border-[#E4E7EC] bg-white py-3 pl-10 pr-4 text-[#101828] outline-none focus:border-[#00A878] focus:ring-2 focus:ring-[#ECFDF5]"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#101828]">
                  Medicine Type <span className="text-[#F97316]">*</span>
                </label>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full rounded-xl border border-[#E4E7EC] bg-white px-4 py-3 text-[#101828] outline-none focus:border-[#00A878] focus:ring-2 focus:ring-[#ECFDF5]"
                >
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-[#101828]">
                  Manufacturer <span className="text-[#F97316]">*</span>
                </label>
            ...
            <div className="mt-7 rounded-xl border border-[#A7F3D0] bg-[#ECFDF5] p-4">
              <p className="text-sm leading-6 text-[#475467]">
                <strong className="text-[#101828]">Note:</strong> Storage
                temperature will later be used by MediSure for cold-chain
                verification and Trust Score calculation.
              </p>
            </div>
            ...
            <button
              type="submit"
              className="mt-7 flex w-full items-center justify-center gap-2 rounded-xl bg-[#00A878] px-6 py-4 font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#008F68]"
            >
